...
export function EodHubClient({ userName }) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div
        className={`rounded-2xl p-6 sm:p-8 text-white relative overflow-hidden shadow-lg transition-all ${status === "submitted" ? "bg-gradient-to-br from-emerald-500 to-emerald-700" : "bg-gradient-to-br from-amber-500 to-orange-600"}`}
      >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Link
          href="/eod/submit"
          className="card p-5 sm:p-6 hover:shadow-md hover:border-primary/30 hover:bg-primary/5 transition-all group active:scale-[0.98]"
        >
