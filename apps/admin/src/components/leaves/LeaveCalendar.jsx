  ...
  return (
    <div className="bg-card rounded-xl border border-border overflow-hidden shadow-sm animate-in fade-in zoom-in-95 duration-300">
      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="grid grid-cols-7 gap-1 sm:gap-2">
          {blanks.map((_, i) => (
            <div
              key={`blank-${i}`}
              className="min-h-[80px] sm:min-h-[100px] p-1 opacity-50 bg-muted/20 rounded-lg border border-transparent"
            ></div>
          ))}
      ...
      {selectedDateInfo && (
        ...
        >
          <div
            className="bg-card w-full max-w-md rounded-2xl shadow-xl border border-border overflow-hidden animate-in zoom-in-95 duration-200"
