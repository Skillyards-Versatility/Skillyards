            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-muted/40 border-b border-border/60">
                  ...
                  <th className="hidden md:table-cell px-6 py-4 text-xs font-bold uppercase tracking-widest text-muted-foreground">
                    Team
                  </th>
                  <th className="hidden lg:table-cell px-6 py-4 text-xs font-bold uppercase tracking-widest text-muted-foreground">
                    Created
                  </th>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="min-w-0">
                            ...
                            <div className="flex items-center gap-1.5 mt-1 sm:hidden flex-wrap">
                              ...
                              {user.team && (
                                <span
                                  className={`px-2 py-0.5 rounded-full text-xs font-medium ${TEAM_BADGE_CLASSES[user.team] || ""}`}
                                >
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 flex-wrap pl-16">
                    ...
                    {user.team && (
                      <span
                        className={`px-2 py-0.5 rounded-full text-[10px] font-medium ${TEAM_BADGE_CLASSES[user.team] || ""}`}
                      >
                        {TEAM_LABELS[user.team] || user.team}
                      </span>
                    )}
            ...
            <div className="p-6 sm:p-8 space-y-8">
              ...
              <div className="bg-muted/30 p-5 rounded-2xl border border-border/50 mt-8">
                ...
                <ul className="text-xs text-muted-foreground space-y-2.5 list-disc pl-4">
                  <li>
                    New users should change their password upon first login.
                  </li>
                  <li>
                    Administrator roles have full access to database schema and
                    settings.
                  </li>
