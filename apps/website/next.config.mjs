...
const nextConfig = {
  ...
  async headers() {
    ...
    return isDev ? [swHeaders] : [swHeaders, staticCacheHeaders, cspHeaders];
  },
  ...
  async redirects() {
    return [
      ...
      {
        source:
          "/programs/on-job-degree/best-bca-course-in-agra-with-job-training",
        destination: "/bca-training-program-in-agra",
        permanent: true,
      },
      {
        source:
          "/programs/on-job-degree/best-bba-course-in-agra-with-job-training",
        destination: "/bba-training-program-in-agra",
        permanent: true,
      },
      {
        source:
          "/programs/on-job-training/best-full-stack-development-course-in-agra",
        destination: "/full-stack-web-development-training-in-agra",
        permanent: true,
      },
      {
        source:
          "/programs/on-job-training/best-digital-marketing-course-in-agra",
      ...
      {
        source: "/programs/fullstack",
        destination: "/full-stack-web-development-training-in-agra",
        permanent: true,
      },
      {
        source: "/programs/full-stack",
        destination: "/full-stack-web-development-training-in-agra",
        permanent: true,
      },
      {
        source: "/programs/digitalmarketing",
        destination: "/digital-marketing-course-in-agra",
        permanent: true,
      },
      {
      ...
      {
        source: "/programs/mern-stack-developer",
        destination: "/full-stack-web-development-training-in-agra",
        permanent: true,
      },
      {
        source: "/programs/bachelor-of-computer-applications-bca",
        destination: "/bca-training-program-in-agra",
        permanent: true,
      },
      ...
      {
        source: "/suryanshupadhyay",
        destination: "/team/suryanshupadhyay",
        permanent: true,
      },
      {
        source: "/rahulsingh",
        destination: "/team/rahulsingh",
        permanent: true,
      },
      {
        source: "/team/suryansh-upadhyay",
        destination: "/team/suryanshupadhyay",
        permanent: true,
      },
      {
        source: "/team/rahul-singh",
        destination: "/team/rahulsingh",
        permanent: true,
      },
      ...
      {
        source: "/on-job-training",
        destination: "/programs/on-job-training",
        permanent: true,
      },
      ...
      {
        source:
          "/programs/on-job-degree/best-bba-college-in-agra-with-digital-skills",
        destination: "/bba-training-program-in-agra",
        permanent: true,
      },
      ...
      {
        source:
          "/programs/on-job-training/digital-marketing-course-in-agra-with-live-projects",
        destination: "/digital-marketing-course-in-agra",
        permanent: true,
      },
