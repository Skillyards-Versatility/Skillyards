export const faqCategories = {
  about: {
    ...
    faqs: [
      ...
      {
        question:
          "What makes SkillYards different from a generic training institute?",
        answer:
  ...
  general: {
    ...
    faqs: [
      ...
      {
        question:
          "What's the difference between a Degree program and a Skill Course?",
        answer:
  ...
  ojt: {
    ...
    description:
      "Everything about SkillYards' AI-integrated On-Job Training programs in Agra.",
    faqs: [
      {
  ...
  fullstack: {
    ...
    faqs: [
      {
        question:
          "Is this Full-Stack Web Development Course in Agra offline or online?",
        answer:
    ...
    faqs: [
      {
        ...
        answer:
          "No prior marketing or tech background is required. The course starts from fundamentals and is designed for beginners.",
      },
      {
      ...
      {
        question:
          "Will I get hands-on practice running campaigns during the course?",
        answer:
          "Students work on mentor-guided practical projects, SEO audits, ad campaign planning, reporting exercises, and portfolio-ready case work. Selected students may also get exposure to live business campaigns where available.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Placement assistance includes resume building, portfolio review, mock interviews, LinkedIn/profile support, interview preparation, counselling, and relevant opportunity referrals where available. It is not a job guarantee.",
      },
      {
        question:
          "Can I freelance after this course? Will SkillYards help me get work?",
        answer:
      ...
      {
        question:
          "Are there evening or weekend batches for working professionals?",
        answer:
          "Batch schedules may vary. Contact SkillYards to know the current weekday or weekend availability for the upcoming batch.",
      },
      {
        question:
          "How is this different from doing a free Google Digital Garage course?",
        answer:
  ...
  degrees: {
    ...
    faqs: [
      ...
      {
        question:
          "What is the OJT (On-Job Training) component in degree programs?",
        answer:
