...
export const metadata = buildSEO({
  title:
    "Free 10-Minute Skill Test | HTML, CSS, JS & SEO Certificate — SkillYards",
  description:
...
export default async function TenMinuteTestPage() {
  const webPageSchema = getWebPageSchema({
    ...
    description:
      "Take SkillYards' free 10-minute skill assessment in HTML, CSS, JavaScript, and SEO.",
  });
  ...
  const quizSchema = getQuizSchema({
    ...
    description:
      "Evaluate your core web development and digital marketing skills in just 10 minutes.",
  });
