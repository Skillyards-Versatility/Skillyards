...
async function getJob(slug) {
  return {
    ...
    experience_max: 2,
    description:
      "<p>This is a placeholder job description. Connect the API to see real job postings.</p>",
    responsibilities:
      "<ul><li>Collaborate with the team</li><li>Build amazing products</li></ul>",
    requirements:
      "<ul><li>Passion for learning</li><li>Strong communication skills</li></ul>",
    salary_min: null,
    salary_max: null,
    apply_deadline: null,
...
async function CareerJobPage({ params }) {
  ...
  const isExpired =
    job.apply_deadline && new Date(job.apply_deadline).getTime() < Date.now();
  return (
    <>
      <section className="bg-white dark:bg-neutral-950 py-20">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div
            ...
            dangerouslySetInnerHTML={safeHtml(job.description)}
          />
          ...
          {job.responsibilities && (
            <>
              ...
              <div
                ...
                dangerouslySetInnerHTML={safeHtml(job.responsibilities)}
              />
            </>
          )}
          ...
          {job.requirements && (
            <>
              ...
              <div
                className="prose dark:prose-invert"
                dangerouslySetInnerHTML={safeHtml(job.requirements)}
              />
            </>
          )}
        </div>
        ...
        <section className="bg-red-50 dark:bg-red-950/30 border-y border-red-200 dark:border-red-900 py-10">
          <div className="mx-auto max-w-3xl px-6 text-center">
            ...
            <p className="mt-3 text-red-600 dark:text-red-400">
              The application deadline for this role has passed. You can still
              view the job details, but new applications are no longer accepted.
            </p>
          </div>
        </section>
      )}
          ...
          <div className="mx-auto max-w-sm px-6 text-center">
            ...
            <a
              href={
                isExpired
                  ? undefined
                  : `https://admin.skillyards.in/qrcodes/${job.qr_code.uuid}`
              }
