...
export async function generateMetadata() {
  ...
  return buildSEO({
    ...
    ogImage: resolveOgImage(
      ogImages,
      "refund",
      "/images/opengraph/refund-policy-og.jpg",
    ),
  });
}
...
const sections = [
  {
    ...
    content: (
      <p className="text-sm text-muted-foreground leading-relaxed">
        SkillYards offers digital education programs, training services, and
        learning resources. By enrolling in any course or program, you
        acknowledge and agree to the terms outlined in this Refund &
        Cancellation Policy.
      </p>
    ),
  },
    ...
    content: (
      <div className="space-y-3">
        <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          live sessions, or learning resources is provided, the enrollment is
          considered confirmed.
        </p>
        <p className="text-sm text-muted-foreground leading-relaxed">
          Due to the nature of digital content and limited-seat programs,
          refunds may not be available once access has been granted, except in
          specific cases mentioned below.
        </p>
      </div>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-sm text-muted-foreground leading-relaxed">
          Refunds will{" "}
          <span className="font-semibold text-foreground">not</span> be provided
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-sm text-muted-foreground leading-relaxed">
          SkillYards reserves the right to cancel or reschedule any course,
          batch, or training program due to unforeseen circumstances. In such
          cases, learners may be offered:
        </p>
        <ul className="mt-4 space-y-2">
          {[
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          SkillYards is not responsible for delays caused by banks or
  ...
  },
  {
    ...
    content: (
      <p className="text-sm text-muted-foreground leading-relaxed">
        SkillYards reserves the right to update or modify this Refund &
        Cancellation Policy at any time. Changes will be effective immediately
