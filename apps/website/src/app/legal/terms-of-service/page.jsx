...
export async function generateMetadata() {
  ...
  return buildSEO({
    ...
    ogImage: resolveOgImage(
      ogImages,
      "terms",
      "/images/opengraph/terms-of-service-og.jpg",
    ),
  });
}
...
const sections = [
  ...
  },
  {
    ...
    content: (
      <p className="text-sm text-muted-foreground leading-relaxed">
        You must be at least 18 years old to create an account or enroll in paid
        programs on SkillYards. If you are under 18, you may use our services
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          SkillYards reserves the right to suspend or terminate accounts found
          to be using false information or engaging in unauthorized activity.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-3">
        <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          otherwise stated. Payments must be made in full at the time of
          enrollment.
        </p>
        <p className="text-sm text-muted-foreground leading-relaxed">
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        <p className="text-sm text-muted-foreground leading-relaxed">
          All content on SkillYards — including videos, text, graphics, logos,
          designs, course materials, and software — is the intellectual property
          of SkillYards or its content partners.
        </p>
        <p className="text-sm text-muted-foreground leading-relaxed">
  ...
  },
  {
    ...
    content: (
      <p className="text-sm text-muted-foreground leading-relaxed">
        SkillYards reserves the right to suspend or terminate your access to the
        institute or website at its sole discretion, without prior notice, if
        you violate these terms or engage in activities that may harm SkillYards
        or its community.
      </p>
    ),
  },
  {
    ...
    content: (
      <p className="text-sm text-muted-foreground leading-relaxed">
        SkillYards provides its services on an "as is" and "as available" basis.
        We do not guarantee uninterrupted access, error-free content, or
        specific learning or career outcomes.
      </p>
    ),
  },
  {
    ...
    content: (
      <p className="text-sm text-muted-foreground leading-relaxed">
        To the maximum extent permitted by law, SkillYards shall not be liable
