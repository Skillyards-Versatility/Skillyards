...
export async function generateMetadata() {
  ...
  return buildSEO({
    ...
    ogImage: resolveOgImage(
      ogImages,
      "privacy",
      "/images/opengraph/privacy-policy-og.jpg",
    ),
  });
}
...
const sections = [
    ...
    content: (
      <>
        <p className="text-sm text-muted-foreground leading-relaxed">
          We collect information to provide better services and learning
          ...
          {[
            {
              ...
              desc: "Name, email address, phone number, educational background, and other details you provide during registration, enrollment, or communication.",
            },
            {
              label: "Usage Data",
              desc: "Pages visited, time spent on our website, interactions with content, and technical data such as browser type and device information.",
            },
            {
              label: "Payment Information",
              desc: "Payment-related details are processed securely by trusted third-party payment gateways. SkillYards does not store your card or banking information.",
            },
          ].map((item) => (
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-sm text-muted-foreground leading-relaxed">
          The information we collect is used for legitimate educational and
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        <p className="text-sm text-muted-foreground leading-relaxed">
          SkillYards uses cookies and similar technologies to enhance your
          browsing experience. Cookies help us understand how users interact
          with our website, remember preferences, and improve performance.
        </p>
        <p className="text-sm text-muted-foreground leading-relaxed">
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-sm text-muted-foreground leading-relaxed">
          We respect your privacy and do not sell your personal data. Your
  ...
  },
  {
    ...
    content: (
      <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        to safeguard your personal information. While no system is completely
        secure, we continuously work to protect your data against unauthorized
  ...
  },
  {
    ...
    content: (
      <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        SkillYards is not responsible for the privacy practices or content of
        these external websites. We encourage you to review their privacy
        policies separately.
      </p>
    ),
  },
          ...
          <div className="flex gap-12">
            ...
            <div className="flex-1 space-y-6">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <span className="text-[10px] font-bold text-primary/60 tracking-widest">
                          {s.number}
                        </span>
              ...
              <div className="rounded-2xl border border-primary/20 bg-primary/5 p-6 text-center">
                <p className="text-sm text-muted-foreground">
                  By using SkillYards, you agree to the terms of this Privacy
                  Policy.{" "}
                  <Link
