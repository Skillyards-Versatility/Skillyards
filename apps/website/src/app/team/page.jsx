...
export default async function TeamPage() {
  const hasProfile = (slug) => !!TEAM_PROFILES[slug];

  const [leadershipTeam, engineeringTeam, operationsTeam] = (
    await Promise.all([
    ...
    group.map((member) => ({
      ...member,
      slug: hasProfile(member.slug) ? member.slug : undefined,
    })),
  );
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground font-medium max-w-2xl mx-auto leading-relaxed">
            We are a collective of engineers, founders, and community builders
            fiercely dedicated to closing the gap between academic theory and
