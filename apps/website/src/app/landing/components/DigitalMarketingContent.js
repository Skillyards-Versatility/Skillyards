...
export default function DigitalMarketingContent() {
  return (
    ...
    <Card>
      ...
      <CardContent>
        ...
        <ul className="space-y-3 list-disc ml-5 text-muted-foreground">
    ...
    <Card>
      ...
      <CardContent>
        ...
        <ul className="space-y-3 list-disc ml-5 text-muted-foreground">
          ...
          <li>Optimize live business websites</li>

          <li>Rank webpages for local keywords</li>

          <li>Create SEO reports</li>

          <li>Perform complete website audits</li>
          ...
          <li>Analyze Google Search Console data</li>
  ...
  <Table>
    ...
    <TableBody>
      ...
      <TableRow>
        ...
        <TableCell>
          Keywords, On-Page SEO, Website Structure
        </TableCell>
      ...
      <TableRow>
        ...
        <TableCell>
          Technical SEO, Analytics, Local SEO
        </TableCell>
      ...
      <TableRow>
        ...
        <TableCell>
          Audits, AI SEO, Link Building, Strategy
        </TableCell>

        <TableCell>
          Industry Ready SEO Skills
        </TableCell>
    ...
    <Card>
      ...
      <CardContent>
        ...
        <ul className="space-y-3 list-disc ml-5 text-muted-foreground">
          ...
          <li>Create live campaigns</li>
          <li>Write high-converting ad copies</li>
    ...
    <Card>
      ...
      <CardContent>
        ...
        <ul className="space-y-2 list-disc ml-5 text-muted-foreground">
    ...
    <Card>
      <CardHeader>
        <CardTitle>Content AI</CardTitle>
      </CardHeader>
      <CardContent>
        <ul className="space-y-2 list-disc ml-5 text-muted-foreground">
          <li>ChatGPT</li>
  ...
  <div className="space-y-5">
    ...
    <p className="text-lg text-muted-foreground leading-8">
      Our fees are structured to keep quality training accessible for students, graduates, working professionals and business owners.
    ...
    <tbody>
      <tr className="border-b border-border">
        <td className="px-4 py-3 text-muted-foreground">
          Quick Skill Program (AI Bootcamp)
        </td>
        <td className="px-4 py-3">
          <span className="rounded-md bg-primary/10 px-2 py-1 text-primary text-xs font-semibold">
            Contact Us
          </span>
        </td>
        <td className="px-4 py-3 text-muted-foreground">
      ...
      <tr className="border-b border-border">
        <td className="px-4 py-3 text-muted-foreground">
          Digital Marketing On-Job Training
        </td>
        <td className="px-4 py-3 text-muted-foreground">
          7–9 months
        </td>
      ...
      <tr className="border-b border-border">
        <td className="px-4 py-3 text-muted-foreground">
          BBA Digital Marketing (On-Job Degree)
        </td>
        <td className="px-4 py-3 text-muted-foreground">
          3 years
        </td>
  ...
  <p className="text-muted-foreground leading-8">
    EMI available: [CONFIRM]<br/>Included: study material, lab access, certification preparation. [CONFIRM: exam fees]
  </p>
