...
export async function generateMetadata() {
  ...
  return buildSEO({
    ...
    ogImage: resolveOgImage(
      ogImages,
      "gallery",
      "/images/opengraph/gallery-og.jpg",
    ),
  });
}
...
export default function GalleryPage() {
  const collectionSchema = getCollectionPageSchema({
    ...
    description:
      "Explore the SkillYards gallery featuring photos and videos from our campus, training sessions, workshops, and events.",
    keywords: galleryKeywords,
  });
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Browse classroom activities, coding lab sessions, one-on-one
                  mentorship moments, seminars, and workshop events capturing
                  campus life at SkillYards.
                </p>
              </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Watch learning sessions in action, expert panels, technology
                  workshops, campus life reviews, and heartfelt student
                  testimonials and placement success stories.
                </p>
              </div>
