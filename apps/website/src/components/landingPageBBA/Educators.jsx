    ...
    <section className="py-[10vh] md:py-[15vh] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-12 md:mb-16 max-w-3xl mx-auto">
          ...
          >
            Who teaches the{" "}
            <span className="text-primary italic">Digital Marketing</span>{" "}
            program
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            Industry professionals in Agra who work with the tools they teach.
            No theory-only instructors here.
          </motion.p>
        </div>
