  ...
  const trainingPrograms = [
    {
      ...
      description:
        "Learn HTML, CSS, JavaScript, React, Node.js, MongoDB, GitHub, deployment, and AI-assisted coding workflows through offline classroom training in Agra.",
    ...
    },
    {
      ...
      description:
        "Learn SEO, Google Ads, Meta Ads, social media, analytics, reporting, and practical AI-integrated workflows in 6 months.",
    ...
    },
    {
      ...
      description:
        "3-year UGC-recognized degree with full-stack training, live projects, and 100% placement support.",
    ...
    },
    {
      ...
      description:
        "3-year UGC-recognized degree with digital marketing training, live projects, and guaranteed placement.",
      ...
      <div className="mx-auto py-16 px-8 max-w-7xl">
        <div className="flex flex-col md:flex-row gap-20 justify-around items-center">
          ...
          <div className="w-full md:w-[20%] xl:w-[10%] text-center md:text-left mb-8 md:mb-0 mr-2">
            ...
            <p className="text-lg md:text-xl text-primary">Find your passion</p>
          </div>
