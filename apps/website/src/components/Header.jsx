...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      <nav
        className={`w-full max-w-[1100px] flex items-center justify-between p-2 sm:p-2.5 rounded-full border border-border/80 bg-background/80 backdrop-blur-md shadow-sm transition-all duration-300 pointer-events-auto relative z-10`}
      >
