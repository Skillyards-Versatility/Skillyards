...
export default function ApplyForm({ job }) {
  ...
  function validate(form) {
    ...
    if (!form.first_name.value) newErrors.first_name = "First name is required";
    ...
    dark:border-neutral-700`}
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center animate-in fade-in zoom-in duration-500">
          ...
          <p className="mt-3 text-sm text-neutral-500 max-w-md">
            Thank you for applying to SkillYards. If your profile matches, we’ll
