          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center relative z-10">
            ...
            <div className="space-y-4 text-center lg:text-left">
              ...
              <p className="text-muted-foreground text-base sm:text-lg max-w-lg mx-auto lg:mx-0">
                ...
                , updates on new programs, and insider tips straight to your
                inbox.
              </p>
              <p className="text-sm font-medium text-foreground/70 justify-center lg:justify-start flex items-center gap-2 pt-2">
                <span className="flex h-5 w-5 rounded-full bg-green-500/10 items-center justify-center text-green-600">
                  ✓
                </span>{" "}
                Free e-book & exclusive course discounts
              </p>
            </div>
            ...
            <div className="w-full max-w-md mx-auto lg:mx-0 lg:ml-auto">
              ...
              {/* Feedback Messages */}
              {success && (
                <p className="text-green-600 font-medium mt-3 text-center lg:text-right animate-in fade-in">
                  {success}
                </p>
              )}
              {error && (
                <p className="text-red-500 font-medium mt-3 text-center lg:text-right animate-in fade-in">
                  {error}
                </p>
              )}
            </div>
