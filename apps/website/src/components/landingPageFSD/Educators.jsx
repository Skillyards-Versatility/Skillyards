    ...
    <section className="py-[10vh] md:py-[15vh] bg-linear-to-b from-background to-background/50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-12 md:mb-16 max-w-3xl mx-auto">
          ...
          >
            Built by{" "}
            <span className="text-primary italic">Industry Engineers.</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Our engineers are full-stack developers and system designers who
            have built and shipped real production systems.
          </motion.p>
        </div>
