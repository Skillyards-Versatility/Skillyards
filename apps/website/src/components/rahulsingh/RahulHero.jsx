...
const socials = [
  {
    icon: Linkedin,
    url: "https://www.linkedin.com/in/rahul-singh-a90ab630/",
    label: "LinkedIn",
  },
  { icon: Twitter, url: "https://x.com/rsrsrahul444?s=11", label: "Twitter" },
  {
    icon: Instagram,
    url: "https://www.instagram.com/rahul_rs0310?igsh=bmpqejlqZXdsbHN5&utm_source=qr",
    label: "Instagram",
  },
];
    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        ...
        <div className="flex-1 text-center md:text-right max-w-xl">
          ...
          >
            Rahul Singh focuses on operations, curriculum coordination, student
            support, and creating smoother learning experiences that help
            students stay consistent, supported, and career-focused throughout
            their time at SkillYards.
          </m.p>
