...
const WHATSAPP_HREF = `https://wa.me/${process.env.NEXT_PUBLIC_PHONE?.replace(/\D/g, "") || "917060100561"}?text=${encodeURIComponent("Hi, I'm interested in the BCA/BBA On-Job Degree at SkillYards. I'd like a free career counseling session.")}`;
    ...
    outcomes: [
      {
        ...
        desc: "C, C++, Python, Java. Build the mental model that makes every language easy.",
      },
      {
        icon: "🌐",
        title: "Web Development",
        desc: "HTML, CSS, JavaScript, React, Node.js. Build and deploy real web apps.",
      },
      {
        icon: "🗄️",
        title: "Databases",
        desc: "MySQL, MongoDB, and query optimization. Design systems that scale.",
      },
      {
        icon: "☁️",
        title: "Cloud & DevOps",
        desc: "AWS basics, Docker, CI/CD. Skills every modern dev team wants.",
      },
      {
        icon: "🔐",
        title: "Cybersecurity Basics",
        desc: "OWASP fundamentals, secure coding practices, network security.",
      },
      {
        icon: "📜",
        title: "Career Preparation",
        desc: "Project work, portfolio building, interview preparation, and mentor guidance.",
      },
    ],
    quickWins: [
    ...
    outcomes: [
      {
        ...
        desc: "SEO, Meta Ads, Google Ads, email marketing. Learn execution through mentor-guided practical work.",
      },
      {
        icon: "💰",
        title: "Finance & Accounting",
        desc: "Financial statements, budgeting, Tally, GST. The numbers side every business needs.",
      },
      {
        icon: "🤝",
        title: "Sales & Business Development",
        desc: "B2B and B2C sales, CRM tools, and closing deals.",
      },
      {
        icon: "📈",
        title: "Business Strategy",
        desc: "Market analysis, competitive positioning, growth frameworks.",
      },
      {
        icon: "🌐",
        title: "E-Commerce & Startups",
        desc: "How modern businesses are built — product, ops, customer acquisition, scaling.",
      },
      {
        icon: "📜",
        title: "Career Preparation",
        desc: "Project work, presentations, communication, and mentor guidance.",
      },
    ],
    quickWins: [
...
const comparisonRows = [
  {
    ...
    aspect: "What You Get",
    traditional:
      "Only a degree certificate. No real skills, no work experience.",
    skillyards:
      "Degree + industry skills + 3 years of on-job training in the same program.",
  },
  {
    icon: Laptop,
    aspect: "Laptop",
  ...
  },
  {
    ...
    traditional:
      "Graduate with 0 months of experience. Struggle to get the first job.",
    skillyards:
      "Graduate with 3 years of verifiable work experience on your CV.",
  },
  {
    icon: Trophy,
    aspect: "Placement",
    ...
    skillyards:
      "Dedicated placement support with resume building, mock interviews, and career guidance.",
  },
  {
    icon: Check,
    ...
    skillyards:
      "Industry-current tools and practical projects. Updated regularly.",
  },
  {
    icon: Check,
    aspect: "After Graduation",
    traditional:
      "Start from zero. Compete with thousands of other fresh graduates.",
...
const testimonials = [
  {
    ...
    program: "BCA",
    quote:
      "The practical projects helped me understand how to explain my work clearly in interviews — especially databases and backend basics.",
  ...
  },
  {
    ...
    program: "BBA",
    quote:
      "The mentor feedback on my assignments and reports helped me build confidence and a portfolio I could present during interviews.",
  ...
  },
  {
    ...
    program: "BCA",
    quote:
      "The free laptop wasn't a gimmick — we used it for real projects with real deadlines. By end of year 1 I already had a portfolio.",
  ...
  },
  {
    ...
    program: "BBA",
    quote:
      "My classmates from regular BBA colleges spent months after graduation in unpaid internships. I already had 2 years of business experience on my CV.",
    outcome: "3 LPA at 21",
  },
  {
    name: "Rohan Verma",
    ...
    program: "BCA",
    quote:
      "The practical projects and mentor feedback helped me build confidence and a portfolio I could explain clearly.",
  ...
  },
  {
    ...
    program: "BBA",
    quote:
      "The mentor-guided assignments and presentations helped me understand how to communicate my work professionally.",
...
const faqs = [
  {
    q: "Is the degree recognized by UGC / universities?",
    a: "Yes. Both BCA and BBA degrees are from a recognized university, valid for higher education and government jobs exactly like any other UG degree.",
  },
  {
    q: "What is on-job training exactly?",
    a: "It means practical, mentor-guided project work alongside your degree curriculum — focused on skills, portfolio building, and career preparation.",
  },
  {
    q: "Is the laptop really free?",
    a: "Please confirm current laptop availability and terms with the admissions team during counseling. We avoid making time-sensitive promises on the website.",
  },
  {
    q: "Which program should I choose — BCA or BBA?",
    a: "BCA is for you if you're drawn to technology, coding, and building software. BBA is for you if you're drawn to business, marketing, sales, or management.",
  },
  {
    q: "What if I'm not sure which stream to pick?",
    a: "Book a free career counseling session on WhatsApp. We'll talk through your interests and help you decide — no pressure.",
  },
];
...
function Hero({ active, setActive }) {
  const heroPills = [
    {
      icon: <Laptop size={12} />,
      label: "Free Laptop Included",
      cls: "bg-[#dc2626] text-white shadow-lg shadow-[#dc2626]/25",
    },
    {
      icon: <Clock size={12} />,
      label: "3 Years Program",
      cls: "bg-[#f97316] text-white shadow-lg shadow-[#f97316]/25",
    },
    {
      icon: <Calendar size={12} />,
      label: "Admissions via counseling",
      cls: "border border-white/10 bg-white/8 text-slate-100 backdrop-blur",
    },
  ];
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5">
        ...
        <div className="grid items-start gap-6 lg:grid-cols-[minmax(0,1fr)_400px] lg:gap-12 xl:grid-cols-[minmax(0,1fr)_440px] xl:gap-16">
          <div className="text-center lg:pt-8 lg:text-left xl:pt-10">
            ...
            >
              Get UGC certified{" "}
              <strong className="text-[#f97316] font-black">Degree</strong>,{" "}
              <strong className="text-[#f97316] font-black">Skills</strong> and{" "}
              <strong className="text-[#f97316] font-black">placement</strong>{" "}
              at the same place.
            </motion.p>
            ...
            >
              {heroPills.map((p, i) => (
                <span
                  key={i}
                  className={`flex items-center gap-1.5 rounded-full px-3 py-1.5 text-[11px] font-bold sm:px-3.5 sm:py-2 sm:text-xs ${p.cls}`}
                >
                  {p.icon} {p.label}
                </span>
              ))}
            ...
            >
              <span className="text-[#fca5a5]">
                Apply before May ends. Priority seats closing fast.
              </span>
            </motion.div>
          ...
          >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {active === "bca"
                  ? "Tech careers with real job training."
                  : "Business careers with real job training."}
              </motion.p>
            </AnimatePresence>
            ...
            <div className="mt-4 space-y-3 sm:mt-6">
              <div className="rounded-2xl border border-white/10 bg-white/6 p-3.5 sm:p-4">
                ...
                <p className="mt-1 text-base font-extrabold text-white sm:text-lg">
                  {programs[active].full}
                </p>
                <p className="mt-1 text-xs text-[#fdba74] sm:text-sm">
                  {programs[active].tagline}
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-[#dc2626]/30 bg-[#dc2626]/12 p-3.5 sm:p-4">
                <p className="text-[11px] font-bold uppercase tracking-wider text-[#fca5a5]">
                  Urgent
                </p>
                <p className="mt-1 text-xs font-semibold leading-relaxed text-white sm:text-sm">
                  Apply before May ends. Priority seats are getting filled
                  first.
                </p>
    ...
    <section className="relative overflow-hidden border-y border-white/10 bg-[#111827] py-10 md:py-16">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-5">
        <div className="text-center">
          ...
          >
            Learn With{" "}
            <span className="italic text-[#dc2626]">AI Built In</span>
          </motion.h2>
        </div>
    ...
    <section className="bg-[#111827] py-14 md:py-20">
      <div className="mx-auto max-w-6xl px-5">
        <div className="mb-8 text-center md:mb-10">
          ...
          >
            One Framework.{" "}
            <span className="italic text-[#dc2626]">Two Degrees.</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
          ...
          >
            <div className="flex h-full flex-col">
              ...
              <p className="mt-4 text-lg font-semibold leading-snug text-slate-900 sm:text-xl">
                {active === "bca"
                  ? "Build products, systems, and developer credibility."
                  : "Build revenue, campaigns, and business credibility."}
              </p>
              <p className="mt-2 text-sm leading-relaxed text-slate-600">
                {prog.full} with free laptop, on-job training, and placement
                support built in.
              </p>
    ...
    <section className="relative overflow-hidden bg-[#111827] py-16 md:py-24">
      ...
      <div className="mx-auto max-w-5xl px-5">
        ...
        <div className="mb-10 text-center md:mb-12">
          ...
          >
            SkillYards <span className="italic text-[#dc2626]">vs</span>{" "}
            Traditional College
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
          ...
          >
            A degree from a traditional college gets you a certificate.
            SkillYards gives you the certificate, the skills, the experience,
            and the job.
          </motion.p>
        </div>
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[#111827] text-white">
                <th className="px-5 py-4 text-left font-bold w-[22%]">
                  Aspect
                </th>
                <th className="px-5 py-4 text-left font-bold w-[39%] opacity-70">
                  Traditional College
                </th>
                <th className="px-5 py-4 text-left font-bold w-[39%]">
                  SkillYards OJD
                </th>
              </tr>
            </thead>
            <tbody>
              {comparisonRows.map((row, i) => {
                ...
                return (
                  <tr
                    key={i}
                    className={`border-t border-[#fed7aa] hover:bg-[#fff7ed] ${i % 2 === 0 ? "bg-white" : "bg-[#fffbf5]"}`}
                  >
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-start gap-2 text-slate-600">
                        <X
                          size={14}
                          className="mt-0.5 shrink-0 text-[#dc2626]/55"
                        />
                        {row.traditional}
                      </div>
                    </td>
              ...
              >
                ...
                <div className="grid grid-cols-2">
                  ...
                  <div className="bg-[#fff7ed] px-4 py-3">
                    <p className="mb-1.5 text-[10px] font-bold uppercase tracking-[0.14em] text-[#b91c1c]">
                      SkillYards
                    </p>
                    <div className="flex items-start gap-1.5">
                      <Check
        ...
        >
          <div className="text-center">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-600 sm:text-base">
              Choose degree with real work, real tools, and job-ready output
              from semester 1.
            </p>
          </div>
        </motion.div>
          ...
          >
            ...
            <ul className="space-y-3">
              {goodFit.map((item, i) => (
                <li
                  key={i}
                  className="flex items-start gap-2.5 text-sm leading-relaxed text-slate-900"
                >
                  <CheckCircle2
                    size={15}
                    className="mt-0.5 shrink-0 text-[#dc2626]"
            ...
            <ul className="space-y-3">
              {notFit.map((item, i) => (
                ...
                >
                  <XCircle
                    size={15}
                    className="mt-0.5 shrink-0 text-[#dc2626]/60"
                  />
                  {item}
                </li>
              ))}
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <p className="text-sm font-extrabold text-slate-900">
                If this sounds like you, don&apos;t wait for final admission
                rush.
              </p>
    ...
    <section className="bg-[#111827] py-16 text-white md:py-20">
      <div className="mx-auto max-w-6xl px-5">
        <div className="text-center mb-10">
          ...
          >
            Real projects create pressure. Mentors make sure that pressure turns
            into job-ready skill, not confusion.
          </motion.p>
        </div>
        <motion.div
        ...
        >
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {mentors.map((mentor) => (
              <div
                key={mentor.name}
                className="rounded-[1.75rem] border border-[#dc2626]/18 bg-[#0f172a] p-6 text-center md:text-left"
              >
                ...
                <h3 className="mt-5 font-serif text-2xl font-extrabold text-white">
                  {mentor.name}
                </h3>
                <p className="mt-1 text-sm font-semibold text-[#fdba74]">
                  {mentor.role}
                </p>
                ...
                <ul className="mt-5 flex flex-wrap justify-center gap-2 md:justify-start">
                  {mentor.chips.map((chip, i) => (
                    <li
                      key={i}
                      className="flex items-center gap-1.5 rounded-full border border-[#dc2626]/18 bg-[#dc2626]/10 px-3 py-1 text-[11px] font-semibold text-[#fca5a5]"
                    >
            ...
            <div>
              ...
              <div className="mt-4 rounded-[1.5rem] border border-[#f97316]/20 bg-[#f97316]/10 p-5">
                ...
                <p className="mt-2 text-sm leading-relaxed text-white">
                  Most students fail because nobody corrects them early. Here,
                  mentors close that gap before it becomes a weak portfolio,
                  weak interview, or wasted semester.
                </p>
              </div>
            </div>
            ...
            <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <p className="text-sm font-extrabold text-white">
                  Guidance matters more when seats are limited and time is
                  moving.
                </p>
                <p className="mt-1 text-xs leading-relaxed text-slate-300">
                  Meet team, understand training model, then decide fast with
                  clarity.
                </p>
              </div>
              <a
    ...
    <section className="bg-[#111827] py-16 md:py-24">
      <div className="mx-auto max-w-6xl px-5">
        <div className="mb-8 text-center md:mb-12">
          ...
          >
            Real Results,{" "}
            <span className="italic text-[#dc2626]">Real People</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
          ...
          {testimonials.map((t, i) => (
            <motion.div
              ...
              className={`relative overflow-hidden rounded-[1.75rem] border border-[#fed7aa] bg-white p-5 transition-all hover:-translate-y-1 hover:border-[#dc2626]/20 hover:shadow-md sm:p-6 ${
                i >= MOBILE_TESTIMONIAL_PREVIEW_COUNT && !showAllTestimonials
                  ? "hidden sm:block"
                  : ""
              }`}
            >
              <Quote
                size={20}
                className="absolute right-5 top-5 text-[#dc2626]/10"
              />
        ...
        >
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-1 text-xs leading-relaxed text-slate-600 sm:text-sm">
                Start with demo class, see training model, then lock your path
                early.
              </p>
            </div>
            <a
  ...
  return (
    <section className="relative overflow-hidden bg-[#111827] py-20">
      ...
      <div className="relative z-10 mx-auto max-w-2xl px-5 text-center">
        ...
        >
          Book a free demo class. See exactly how the program works, meet the
          mentors, and decide with full information.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        <p className="mt-4 text-[11px] text-slate-400">
          No spam. No pressure. Your questions first, enrollment when
          you&apos;re ready.
        </p>
      </div>
    </section>
