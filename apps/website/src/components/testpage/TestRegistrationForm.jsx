...
export default function TestRegistrationForm() {
  ...
  return (
    <section
      id="register"
      className="bg-background border-y border-border py-16 px-4 sm:px-6"
    >
      <div className="mx-auto max-w-lg">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-muted-foreground">
            Fill in your details below — we&apos;ll email your certificate and
            result report instantly after you finish.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-center text-xs text-muted-foreground">
            Your details are only used to send your certificate. We don&apos;t
            spam.
          </p>
        </form>
      </div>
