  ...
  try {
    ...
    if (!file || !telecallerId || !phone) {
      return Response.json(
        {
          success: false,
          message: "Missing required fields (file, telecallerId, phone)",
        },
        { status: 400 },
      );
    }
    ...
    const contactedAt = contactedAtInput
      ? new Date(contactedAtInput)
      : new Date();
    ...
    const isTraining =
      ...
      (isTrainingInput === null && user.isTraining);
    ...
    ctx.log("CUSTOM_RECORDING_LOGGED", {
