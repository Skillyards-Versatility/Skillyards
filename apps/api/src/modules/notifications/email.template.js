    ...
    <div style="max-width:560px;margin:auto;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e2e8f0;">
      ...
      <div style="padding:24px 28px 0;">
        <div style="text-align:center;margin-bottom:20px;">
          <div style="display:inline-block;background:${statusBg};border:2px solid ${statusBorder};border-radius:50%;width:64px;height:64px;line-height:64px;font-size:28px;">${statusEmoji}</div>
        </div>
        <p style="font-size:11px;text-transform:uppercase;letter-spacing:1.5px;color:#94a3b8;margin:0 0 4px;font-weight:600;text-align:center;">Leave ${status}</p>
        <p style="font-size:20px;font-weight:700;color:#1e293b;margin:0 0 4px;text-align:center;">Your ${TYPE_LABELS[type] || type} leave has been ${isApproved ? "approved" : "rejected"}</p>
        <p style="font-size:14px;color:#64748b;margin:0 0 24px;text-align:center;">Reviewed by ${approvedByName}</p>

        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:20px;">
          <div style="background:#f8fafc;border-radius:10px;padding:14px 16px;border:1px solid #e2e8f0;">
            <p style="font-size:11px;color:#94a3b8;margin:0 0 3px;text-transform:uppercase;letter-spacing:1px;font-weight:600;">Status</p>
            <p style="font-size:14px;font-weight:600;color:${statusColor};margin:0;">${status}</p>
          </div>
          <div style="background:#f8fafc;border-radius:10px;padding:14px 16px;border:1px solid #e2e8f0;">
