...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        {
          ...ogImageField('Home', 'Used on the homepage and as the default fallback.'),
          name: 'home',
        },
        ...
        {
          ...ogImageField('Gallery', 'Shared by /gallery, /gallery/images and /gallery/videos.'),
          name: 'gallery',
        },
        {
          ...ogImageField(
            'Programs Index',
            'Shared by /programs, /programs/on-job-degree and /programs/on-job-training.',
          ),
          name: 'programs',
        },
