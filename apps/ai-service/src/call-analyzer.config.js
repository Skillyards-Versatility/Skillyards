...
const STAGE = {
  ...
  properties: {
    status: {
      type: "string",
      enum: ["completed", "partial", "missed", "not_applicable"],
    },
...
export const RESPONSE_SCHEMA = {
  ...
  properties: {
    transcription: {
      type: "string",
      description: "Verbatim transcript of the call, distinguishing speakers.",
    },
    callSummary: {
      type: "string",
      description: "2-3 sentence neutral summary of the call.",
    },
    ...
    leadProfile: {
      ...
      properties: {
        ...
        speakingWith: {
          type: "string",
          enum: ["student", "parent", "both", "unknown"],
        },
        programInterest: {
          type: "string",
          enum: [
            "ojd_bca",
            "ojd_bba",
            "accelerator_fullstack",
            "accelerator_appdev",
            "accelerator_dataanalytics",
            "accelerator_digitalmarketing",
            "accelerator_cybersecurity",
            "accelerator_investmentbanking",
            "online_degree",
            "undecided",
            "other",
            "unknown",
        ...
        decisionMaker: {
          type: "string",
          enum: ["self", "parent", "family", "unknown"],
        },
        budgetSensitivity: {
          type: "string",
        ...
        leadGrade: {
          type: "string",
          enum: ["A_hot", "B_warm", "C_cold", "unqualified"],
        },
      },
      required: [
        "prospectName",
    ...
    scriptAdherence: {
      ...
      required: [
        ...
        "implicationAmplified",
        "qualificationQuestions",
        "decisionMakerIdentified",
        "valueStackPitch",
        "programModelExplained",
        "objectionHandling",
        "softCTA",
        "strongCTA",
        "urgencyCreated",
    ...
    objectionsRaised: {
      ...
      items: {
        ...
        properties: {
          ...
          handledEffectively: {
            type: "string",
            enum: ["well", "adequate", "poor", "ignored"],
          },
        ...
        properties: {
          claimType: {
            ...
            enum: [
              ...
              "guaranteed_stipend",
              "free_laptop",
              "hiring_partner_count",
              "specific_placement_claim",
              "misleading_urgency",
              "pressure_tactic",
              "other",
            ],
    ...
    toneAndDelivery: {
      ...
      properties: {
        ...
        talkToListenBalance: {
          type: "string",
          enum: ["good", "counselor_dominated", "customer_dominated"],
        },
        languageProfessionalism: {
          type: "string",
          enum: ["professional", "acceptable", "poor"],
        },
    ...
    scores: {
      ...
      properties: {
        ...
        compliance: {
          type: "integer",
          description: "Lower when risky/absolute claims are made.",
        },
