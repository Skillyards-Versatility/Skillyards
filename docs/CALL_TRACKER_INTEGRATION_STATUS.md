...
1.  **Call History on Enquiries Dialog**:
    ...
    - _Next Step_: Embed a "Call History" panel inside the Enquiry Details dialog on the Enquiries page. When a sales agent opens an enquiry, it should display all calls made to that lead's phone number, complete with durations and inline play buttons.
2.  **Lead Association**:
